...
public class SpendingTracker extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Connection conn = createConnection();
        new Category(conn).setVisible(true);
        ...
        try{
            ...
            if(dt!=null && !s1.equals("") && !c.equals("")){
                ...
                while(isSuccess == false){
                    ...
                    try{
                        var res = st.executeUpdate("insert into spendings (sid,category,sdate,amount) values('"+randomNum+"','"+c+"','"+date+"',"+amount+")");
                        System.out.println("Hello Dasa");
